...
function HarViewer(id,additionnalIndicators){
    ...
    this.initButtonReload = function(){
        ...
        this.reload.src = 'img/har-viewer/reload.png';
    ...
    this.initButtonDisplayWaterFall = function(){
        ...
        this.displayWaterFall.src = 'img/har-viewer/displayWaterFall.png';
    ...
    this.initButtonDisplayDetails = function(){
        ...
        this.displayDetails.src = 'img/har-viewer/displayDetails.png';
        ...
        for (var i = 0; i < this.showedEntries.length; i++) {
            ...
            for (var j = 0; j < this.listFilters.length; j++) {
                ...
                if (this.listFilters[j] == 'URL') {
                    field.innerHTML = '<a href="'+entry[this.listFilters[j]]+'" title="'+entry[this.listFilters[j]]+'" class="tooltipHarView" >'+entry[this.listFilters[j]]+'</a>';
                } else {

                    field.innerHTML = '<p title="'+entry[this.listFilters[j]]+'" class="tooltipHarView">'+entry[this.listFilters[j]]+'</p>';
    ...
    this.initWaterFallRows = function(){
        ...
        for (var i = 0; i < this.showedEntries.length; i++) {
            ...
            $('#HarViewerWaterFallRowAllTiming_'+i).addClass('tooltipHarView');
