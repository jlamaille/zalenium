...
When designing automated tests, we may need a light proxy to do actions like overloading request headers, recovery of times for each request, blocking of certain urls, etc.
