...
public interface ZaleniumCapabilityType {
    ...
    String BROWSERMOBPROXY_WHITE_LIST_NO_PREFIX = "bp-white-list";
    String BROWSERMOBPROXY_WHITE_LIST = CUSTOM_CAPABILITY_PREFIX.concat(BROWSERMOBPROXY_WHITE_LIST_NO_PREFIX);
    String BROWSERMOBPROXY_BLACK_LIST_NO_PREFIX = "bp-black-list";
    String BROWSERMOBPROXY_BLACK_LIST = CUSTOM_CAPABILITY_PREFIX.concat(BROWSERMOBPROXY_BLACK_LIST_NO_PREFIX);
    String BROWSERMOBPROXY_HEADERS_NO_PREFIX = "bp-headers";
    String BROWSERMOBPROXY_HEADERS = CUSTOM_CAPABILITY_PREFIX.concat(BROWSERMOBPROXY_HEADERS_NO_PREFIX);
    String BROWSERMOBPROXY_CAPTURE_SETTINGS_NO_PREFIX = "bp-capture-settings";
    String BROWSERMOBPROXY_CAPTURE_SETTINGS_HEADERS = CUSTOM_CAPABILITY_PREFIX.concat(BROWSERMOBPROXY_CAPTURE_SETTINGS_NO_PREFIX);
